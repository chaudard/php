...
<html>
    ...
    <body>
        <form action="minichat_post.php" method="post">
            <p>
                <label for="pseudo">Pseudo</label> : <input type="text" name="pseudo" id="pseudo" required value="<?php echo $_SESSION['pseudo']?>"/><br />
        ...
        {
        	echo '<p><em>' . htmlspecialchars($donnees['date_message']) . '</em> <strong>' . htmlspecialchars($donnees['pseudo']) . '</strong> : ' . htmlspecialchars($donnees['message']) . '</p>';
        }
